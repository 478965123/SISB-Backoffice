...
import { Search, Filter, UserCheck, UserX, Eye, Mail, Phone, Calendar, Download, RotateCcw, User, GraduationCap, Activity, FileText, MessageSquare } from "lucide-react"
                    ...
                    <div className="flex gap-1">
                      <Dialog>
                        ...
                        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                          <DialogHeader>
                            <DialogTitle className="text-2xl">Application Details - {parent.studentName}</DialogTitle>
                            <DialogDescription>
                          ...
                          <div className="space-y-4">
                              ...
                              <CardContent>
                                <div className="grid grid-cols-3 gap-4">
                                  <div className="space-y-1">
                                    ...
                                    <p className="font-medium">{parent.studentName}</p>
                                  </div>
                                  <div className="space-y-1">
                                    <Label className="text-xs text-muted-foreground">Student Age</Label>
                                    <p className="font-medium">{parent.studentAge} years old</p>
                                  </div>
                                  <div className="space-y-1">
                                    <Label className="text-xs text-muted-foreground">Grade</Label>
                                    <p className="font-medium">{parent.studentGrade}</p>
                                  </div>
                                </div>
                              </CardContent>
                            </Card>
                            ...
                            {parent.notes && (
                              <Card>
                                ...
                                <CardContent>
                                  <p className="text-sm bg-muted/50 p-3 rounded-md">{parent.notes}</p>
                                </CardContent>
                              </Card>
                            )}
